...
| P@3 | 0.87 | 0.90 | -0.03 |
| P@5 | 0.88 | 0.90 | -0.02 |
| R@5 | 0.0245 | 0.0255 | -0.0010 |
| P@10 | 0.85 | 0.88 | -0.03 |
| R@10 | 0.0788 | 0.0490 | +0.0298 |
| mAP | 0.0496 | 0.0489 | +0.0007 |
| Среднее время поиска (Flat), мс | 0.95 | 4.44 | -3.49 |

> *Оценка на 200 изображениях и 10 тестовых запросах. «Золотая» разметка — substring matching в подписях.*
...
1. **Jina v5-omni-nano** (1.04B параметров, truncate_dim=256):
   ...
   - На нашем наборе Jina показывает сопоставимое или чуть лучшее качество по mAP, и значительно более полный охват релевантных документов на top-10 (R@10)
...
3. **FAISS Flat vs HNSW**:
   - Flat: точный поиск, O(N) по памяти, достаточно быстрый для N=200
...
### 1. Подготовка данных ✅
- Датасет: `google-research-datasets/conceptual_captions` (200 изображений, subset для CPU-окружения)
