...
2. **CLIP ViT-B/32** (150M параметров):
   - Преимущество: быстрое построение эмбеддингов, зрелая экосистема и лучшее качество на stock-изображениях Conceptual Captions
   - Ограничение: фиксированное разрешение 224×224
   - На N=500 поиск CLIP оказался быстрее Jina (~0.4 мс vs ~1.3 мс), хотя размерность выше (512 vs 256)
