...
from embeddings import load_jina_model, load_clip_model, encode_texts_jina, encode_texts_clip
...
def main():
    ...
    index_path = FAISS_FLAT_JINA if is_jina else FAISS_FLAT_CLIP
